...
//-----------------------------------------------------------------------------------------------------------------------------------------
     ...
     */
    public function __construct($loggerObj = null, $loggerFunc = null) {

        $this->apiURL     = (config('myfatoorah.mode') == 'live') ? config('myfatoorah.live_url') : config('myfatoorah.test_url');
        $this->apiKey     = trim(config('myfatoorah.token'));
